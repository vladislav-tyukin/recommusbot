...
# ============================================================
# Шаг 2: Получение пользовательских оценок из базы данных
# ============================================================
...
def get_user_ratings_df_from_db(user_id, df, artist_numeric_mapping, genre_numeric_mapping, track_numeric_mapping):
    ...
    # Преобразуем всё это в pandas DataFrame. Наша цель: объединить в единую структуру.
    # У нас нет прямой колонки 'track_name' в БД, так что будем искать по track_id в df.
    # Допустим, у вас в df есть колонка 'track_id'. Если её нет, нужно заранее добавить.
    ...
    # Теперь user_ratings_df содержит все строки, доступные из базы
    # при этом могут повторяться track_name, если пользователь
    # поставил и трек, и жанр/артиста.
